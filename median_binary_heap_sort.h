...
#ifndef MEDIAN_BINARY_HEAP_SORT_H
#define MEDIAN_BINARY_HEAP_SORT_H
...
class UnderflowException { }; //Modified just this line from #include "dsexceptions.h" to not need to include another header since only this one exception is used.
